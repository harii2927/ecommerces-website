...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><a href="c.html" class="under">CONTACT</a></li>
                    <li><a href="a.html" class="under">ABOUT </a></li>
                </ul>
            </div>
            <div class="search">
                    ...
                    <input
                        ...
                        id="input"
                    />
                    <a href=""><ion-icon class="s" name="search"></ion-icon></a>
                ...
                <div class="section2">
                    <div class="container">
                        <div class="items">
                            ...
                            <div class="price">just $350</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="info">
                                Men's Sports Shoes 
                            </div>
                        </div>
                        <div class="items">
                            ...
                            <div class="price">just $600</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="info">Special offers</div>
                        </div>
                        <div class="items">
                            <div class="img img3">
                                <img
                            ...
                            <div class="price">just $999</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="info">Blue jeans</div>
                        </div>
                        <div class="items">
                            <div class="img img1">
                                <img
                        ...
                        <div class="items">
                            ...
                            <div class="price">just $59999</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                        ...
                        <div class="items">
                            ...
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="price">just $18000</div>
                            
                            <div class="info">
                                The best Tv in our honme
                            </div>
                        </div>
                        <div class="items">
                            <div class="img img1">
                            ...
                            <div class="price">just $499</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="info">Men's HOODIES.</div>
                        </div>
                        <div class="items">
                            <div class="img img1">
                                <img
                        ...
                        <div class="items">
                            ...
                            <div class="price">just $49999</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="info">
                                Gameing Laptops
                            </div>
                        ...
                        <div class="items">
                            ...
                            <div class="price">just $1999</div>
                            <a href="details.html"><button class="add-to-cart">Add to Cart</button></a>
                            <div class="info">
                                day start with coffee...
                            </div>
                        </div>
                        <div class="items">
                            <div class="img img1">
        ...
        <footer>
            <div class="footer0"><h1>NammaKadaI</h1></div>
            <div class="footer1">
                Connect with us at
